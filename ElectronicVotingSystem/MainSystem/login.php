      ...
      <div class="wrapper">
        ...
        <form action=""method="POST">
          <div class="row">
            ...
            <input type="text" placeholder="Enter Your Id" required name="username">
          </div>
          <div class="row">
...
if(isset($_POST['username'])){
    ...
    $query="SELECT*FROM voters  WHERE voters_id='$username' AND password='$password'";
    ...
    if($rows==1){
        ...
        echo"<h1>Looged in successfully</h1>";
 
        // header('Refresh: 10; URL=voting.php');
        

      header( "refresh:3;url=voting.php" );
    }
    else{
